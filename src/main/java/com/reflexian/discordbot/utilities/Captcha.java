...
public class Captcha {
    ...
    public static Map<Member, String> captchaMemberMap = new HashMap<>();
...
//        }
    ...
    public void distortionElectric2(double alpha) {
        ...
        dxField = Captcha.gaussian(dxField, 2, 2.2);
        dyField = Captcha.gaussian(dyField, 2, 2.2);
...
//                    System.out.println(target);
    ...
    public void distortionElastic(double alpha, int kernelSize, double sigma) {
        ...
        dxField = Captcha.gaussian(dxField, kernelSize, sigma);
        dyField = Captcha.gaussian(dyField, kernelSize, sigma);
